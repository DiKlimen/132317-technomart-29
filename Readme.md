...
* Студент: [Дмитрий Клименко](https://up.htmlacademy.ru/htmlcss/29/user/132317).
* Наставник: `Без наставника, пока )`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/132317-technomart-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
